...
public class Skeleton : MonoBehaviour
{
    ...
    public int health = 20 + (Data.day * 10);
    public int damage = 3 + Data.day;
    public float speed;
    public Vector3 location; // gameObject.transform.position

    private float distance;

    public float reload = 0f; // arrows
    ...
    void Update()
    {
        ...
        {
            speed = 0.5f * (Mathf.Log(Data.day, 5) * Data.speed * Data.hordeMode);
        }
        ...
        {    
            speed = 1.25f * (Mathf.Log(Data.day, 5) * Data.speed * Data.hordeMode);
        }
        ...
        else if(distance > 3 && Data.speed != 0)
        {
            ...
            // Arrow Firing
            reload += Time.deltaTime * Data.speed / Data.day; // DIFFICULTY
            
            if(reload >= 60.0f / Data.day) // DIFFICULTY
            {
